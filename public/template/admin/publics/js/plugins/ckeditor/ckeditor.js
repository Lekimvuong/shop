...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, g, k, l) {
                function q(a, f, y, l) { a = { name: b, sender: this, editor: a, data: f, listenerData: k, stop: y, cancel: l, removeListener: v }; return !1 === d.call(g, a) ? !1 : a.data }

                function v() { y.removeListener(b, d) } var f = a.call(this, b); if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    g || (g = this);
                    isNaN(l) && (l = 10); var y = this;
                    q.fn = d;
                    q.priority = l; for (var A = f.length - 1; 0 <= A; A--)
                        if (f[A].priority <= l) return f.splice(A + 1, 0, q), { removeListener: v };
                    f.unshift(q) } return { removeListener: v } },
    ...
    (function() {
        var a = [],
            ...
            q = function(a, f) { return "#" == f[0] ? String.fromCharCode(parseInt(f.slice(1), 10)) : l[f] };
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function(a, f) {
                ...
                if (!b) { var d = /\n{2}/g; if (d.test(c)) var n = "\x3c" + l + "\x3e",
                        q = "\x3c/" + l + "\x3e",
                        c = n + c.replace(d, function() { return q + n }) + q }
                c = c.replace(/\n/g, "\x3cbr\x3e");
            ...
            normalizeCssText: function(a, b) { var c = [],
                    l, d = CKEDITOR.tools.parseCssText(a, !0, b); for (l in d) c.push(l + ":" + d[l]);
            ...
            eventsBuffer: function(a, b, c) {
                function l() { q = (new Date).getTime();
                    d = !1;
                    c ? b.call(c) : b() } var d, q = 0; return { input: function() { if (!d) { var b = (new Date).getTime() - q;
    ...
    (function() {
        ...
        function c(a) { for (var b = 0, c = 0, f = k[a].length; c < f; c++) b += parseInt(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                        8 !== CKEDITOR.env.version : 1)) { var r = this.$.getBoundingClientRect(),
                        g = f.$.documentElement,
                    ...
                    for (n = this, w = null; n && "body" != n.getName() &&
                        ...
                        n.equals(this) || (b += n.$.clientLeft || 0, c += n.$.clientTop || 0); for (; w && !w.equals(n);) b -= w.$.scrollLeft, c -= w.$.scrollTop, w = w.getParent();
                        w = n;
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function n(a, b) { var c = { x: 0, y: 0 }; if (!a.is(k ? "body" : "html")) { var f = a.$.getBoundingClientRect();
                        c.x = f.left;
                        c.y = f.top }
                    f = a.getWindow();
                    f.equals(b) || (f = n(CKEDITOR.dom.element.get(f.$.frameElement), b), c.x += f.x, c.y += f.y); return c }
            ...
            copyAttributes: function(a, b) { var c = this.$.attributes;
            ...
            forEach: function(a, b, c) {
                if (!(c || b && this.type != b)) var f =
                    a(this);
                if (!1 !== f) { c = this.getChildren(); for (var d = 0; d < c.count(); d++) f = c.getItem(d), f.type == CKEDITOR.NODE_ELEMENT ? f.forEach(a, b) : b && f.type != b || a(f) }
            }
        });
        ...
        CKEDITOR.dom.element.prototype.getSize =
            function(a, b) { var d = Math.max(this.$["offset" + CKEDITOR.tools.capitalize(a)], this.$["client" + CKEDITOR.tools.capitalize(a)]) || 0;
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) { var F = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            q = function(a) { return k(a) || g(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        ...
        CKEDITOR.dom.element.prototype.getBogus = function() { var a = this;
            do a = a.getPreviousSourceNode(); while (q(a)); return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1 }
    })();
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function n(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && l) return d;
                h || f ? b.append(a.clone(!0, e), c) : (a.remove(), t && b.append(a)); return d }

            function g() { var a, b, c, f = Math.min(N.length, C.length); for (a = 0; a < f; a++)
            ...
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(x, z)), c.append(p);
                ...
                for (var N = p.getParents(), C = m.getParents(), I = g(), G = N.length - 1, K = C.length - 1, J = c, L, Z, U, fa = -1, Q = I; Q <= G; Q++) {
                    Z =
                        N[Q];
                    U = Z.getNext();
                    for (Q != G || Z.equals(C[Q]) && G < K ? b && (L = J.append(Z.clone(0, e))) : F ? n(Z, J, !1, E) : q && J.append(a.document.createText(Z.substring(x))); U;) { if (U.equals(C[Q])) { fa = Q; break }
                        U = n(U, J) }
                    J = L
                }
                J = c;
                for (Q = I; Q <= K; Q++)
                    ...
                    else { Q != K || c.equals(N[Q]) && K < G ? b && (L = J.append(c.clone(0, e))) : B ? n(c, J, !1, v) : O && J.append(a.document.createText(c.substring(0, z))); if (Q > fa)
                            for (; U;) U = n(U, J, !0);
                        J = L }
                h || k()
            }
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var n = function(a, b) {
                            ...
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f =
                                ...
                                F = f != a ? f.getText() : f.substring(b); if (d.test(F)) return !1 }
                            return !0
                        };
                                        ...
                                        if (x && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                            ...
                                            if (d.test(F)) p = null;
                                                ...
                                                for (var B = p.$.getElementsByTagName("*"), E = 0, v; v =
                                                    B[E++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[v.nodeName.toLowerCase()]) { p = null; break }
                                            p && (z = !!F.length)
                                        } else p = null;
                        ...
                        for (; h ||
                            p;) {
                            if (h && !p) {!m && h.equals(g) && (m = !0); if (e ? h.isBlockBoundary() : !k.contains(h)) break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var q, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            ...
                            I = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                                    if (C) { if (C.equals(a)) { C = null; return } } else C = a;
                                else if (C) return; var b = N(a);
                                b || (q = a); return b },
                            e = function(a) { var b = I(a);!b && a.is && a.is("br") && (O = a); return b };
                        h.guard = I;
                        h = h.lastBackward();
                        q = q || k;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { h = this.clone();
                            h = new CKEDITOR.dom.walker(h); var G = CKEDITOR.dom.walker.whitespaces(),
                                K = CKEDITOR.dom.walker.bookmark();
                            h.evaluator = function(a) { return !G(a) && !K(a) }; if ((h = h.previous()) && h.type == CKEDITOR.NODE_ELEMENT && h.is("br")) break }
                        h = this.clone();
                        h.collapse();
                ...
                for (this._.nextNode = null; w;) {
                    ...
                    if (t) w.type == CKEDITOR.NODE_TEXT && e.test(w.getText()) && (t = 0);
                        ...
                        if (CKEDITOR.dtd.$block[p] && "false" == w.getAttribute("contenteditable")) { d = w;
                            b(this, a, d); break } else if (w.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { if ("br" == p) t = 1;
                    ...
                    A = (!H || t) && w.equals(n);
                    if (k && !H)
                        for (; !w.getNext(l) && !A;) { p = w.getParent(); if (p.isBlockBoundary(this.forceBrBreak && !u && { br: 1 })) { H = 1;
                                t = 0;
                                A || p.equals(n);
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (n in N) { f = N[n];
                    t = m[f];
                    g = [];
                    x = void 0; for (x in t) - 1 < x.indexOf("*") ? g.push(new RegExp("^" + x.replace(/\*/g, ".*") + "$")) : g.push(x);
                    t = g;
                    t.length && (m[f] = t, G = !1) }
                m.nothingRequired = G;
        ...
        function q(a, b) { if (!b) return !0; for (var c = 0, d; c < b.length; ++c)
        ...
        function f(a) { var b, c, d, h, p = {},
                e = 1; for (a = Y(a); b = a.match(C);)(c = b[2]) ? (d = y(c, "styles"), h = y(c, "attrs"), c = y(c, "classes")) : d = h = c = null, p["$" + e++] = { elements: b[1], classes: c, styles: d, attributes: h }, a = a.slice(b[0].length); return p }

        function y(a, b) { var c = a.match(I[b]); return c ? Y(c[1]) : null }
        ...
        function r(a, b, h, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) { a: { f = a.elementCallbacks; for (var g = 0, t = f.length, x; g < t; ++g)
                        if (x = f[g](b)) { f = x; break a }
                    f = void 0 } if (f) return f }
            if (e.doTransform && (f = a._.transformations[b.name])) { A(b); for (g = 0; g < f.length; ++g) p(a, b, f[g]);
                n(b) }
            if (e.doFilter) {
                a: {
                    ...
                    if (a || f) { A(b); if (g)
                            for (k = 0, C = g.length; k < C; ++k)
                                if (!1 === c(g[k], b, F)) { a = null; break a }
                        if (t)
                            for (k = 0, C = t.length; k < C; ++k) c(t[k], b, F); if (a)
                            for (k = 0, C = a.length; k < C; ++k) d(a[k], b, F, x); if (f)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (B in l) a.allStyles || z[B] ? E.push(B + ":" + l[B]) : k = !0;
                    E.length && (g.style = E.sort().join("; ")) } else J && (g.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (B = 0; B < t.length; ++B)(a.allClasses || f[t[B]]) && F.push(t[B]);
        ...
        function m(a, b) {
            ...
            for (p in d)
                if ("class" == p)
                    for (c = d[p].split(/\s+/), m = a.classes.join("|"); f = c.pop();) { if (-1 == m.indexOf(f)) return !1 } else if (a.attributes[p] != d[p]) return !1;
            for (e in h)
                if (a.styles[e] !=
                    h[e]) return !1;
            return !0
        ...
        CKEDITOR.filter.prototype = {
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        h; for (b = 0; b < a.length && !h; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (h = c); if (h) { for (b = 0; b < a.length; ++b) d.push(x(a[b], h));
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return {
            ...
            queue: function() {
                ...
                var c = [];
                return function(d, g) { var k = this;
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) { if (e.length) throw Error('[CKEDITOR.resourceManager.load] Resource name "' + k[e[0]].join(",") + '" was not found at "' + e[0] + '".'); for (var f = 0; f < a.length; f++)
                    for (var g = k[a[f]], n = 0; n < g.length; n++) { var w = g[n];
                        l[w] = this.get(w);
                        c[w] = 1 }
                d.call(b, l) }, this)
        }
                ...
                k = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (f in a) { var l = a[f],
                                A = l && l.requires; if (!d[f]) { if (l.icons)
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, h, p, m = 0; m < c.length; m++) { var f = c[m],
                        g = f.startContainer;
            ...
            parse: function(b) {
                for (var c, e, g = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (k) k.push(c[0]);
                                ...
                                q, v = c[4];
                            c = !!c[5]; if (v)
                                for (; q = a.exec(v);) { var f = q[1].toLowerCase();
                                    q = q[2] || q[3] || q[4] || "";
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, k, l) {
                function q(a) { var b; if (0 < w.length)
                ...
                function y(b, c, d) { c = c || u || n; var e = u;
                ...
                D.onTagOpen = function(e, m, f, g) {
                    ...
                    if (a(m)) w.push(m);
                        ...
                        if ("pre" == e) h = !0;
                        else { if ("br" == e && h) { u.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (t = !0) }
                        if ("br" == e) H.push(m);
                        else {
                ...
                D.onText = function(a) { if (!(u._.hasInlineStarted && !H.length || h || t) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = u.name,
                        f = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!t && !f["#"] && b in d) D.onTagOpen(e[b] || ""), D.onText(a);
                    else { v();
                        q();
                        h || t || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (A(u, a)) this.onTagOpen(l, {}, 0, 1);
                        u.add(a) } };
                D.onCDATA =
            ...
            exec: function(a, c) {
                ...
                for (y = 0; y < l; y++)
                    if (d && (q = c.type, v = c.name), f = k[y], !(a.nonEditable && !f.options.applyToAll ||
                            a.nestedEditable && f.options.excludeNestedEditable)) { f = f.value.apply(null, g); if (!1 === f || d && f && (f.name != v || f.type != q)) return f;
                        null != f && (g[0] = c = f) }
                return c
            },
    ...
    (function() {
        ...
        function q(a) { a = a.attributes; switch (a["data-cke-editable"]) {
                case "true":
        ...
        function f(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + r(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }
        ...
        function n(a, b) {
            ...
            for (var m = 0; m < d.length; m++) a = a.replace(d[m], function(a) { a = a.replace(e, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
        ...
        var w = /(?:&nbsp;|\xa0)$/,
            ...
            x = { elements: { embed: function(a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width,
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            writeHtml: function(a, b) { b && this.filter(b); var g = this.name,
                    ...
                    l = this.attributes,
                    q, v;
                a.openTag(g, l); for (q in l) k.push([q, l[q]]);
                a.sortAttributes && k.sort(d);
                q = 0; for (v = k.length; q < v; q++) l = k[q], a.attribute(l[0], l[1]);
    ...
    (function() {
        ...
        function g(a) {
            function b(a) { return function(b, h) { h && b.type == CKEDITOR.NODE_ELEMENT && b.is(f) && (d = b); if (!(h || !c(b) || a && r(b))) return !1 } }
        ...
        function q(a) { var b = a.editor;
            b.getSelection().scrollIntoView();
            setTimeout(function() { b.fire("saveSnapshot") }, 0) }

        function v(a, b, c) { var d = a.getCommonAncestor(b); for (b = a = c ? b : a;
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                getHtmlFromRange: function(a) { if (a.collapsed) return new CKEDITOR.dom.documentFragment(a.document);
                    ...
                    H.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$) },
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(this,
                            "click",
                            function(a) { a = a.data; var b = (new CKEDITOR.dom.elementPath(a.getTarget(), this)).contains("a");
                            ...
                            if (b in l) {
                                ...
                                if (d.collapsed) a: {
                                    ...
                                    if (h && d[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && d.moveToClosestEditablePosition(h, !c) && d.collapsed) {
                                        ...
                                        else { a.fire("saveSnapshot"); var f;
        ...
        n = function() {
            ...
            function d(b, c) { var e = [],
                    ...
                    m, g = 0,
                    k = B[c],
                    x = !b.is(B.$inline) || b.is("br"); for (x && e.push(" "); g < f; g++) m = h.getItem(g), a(m) && !m.is(k) ? e = e.concat(d(m, c)) : e.push(m);
                x && e.push(" "); return e }
            ...
            function g(b, c, d, e) { var h = b.clone(),
                    f, m;
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L = C) {
                        ...
                        if ("text" == n.type && n.inlineStylesRoot) { r = n.inlineStylesPeak;
                            E = r.getDocument().createText("{cke-peak}"); for (I = n.inlineStylesRoot.getParent(); !r.equals(I);) E = E.appendTo(r.clone()), r = r.getParent();
                            C = E.getOuterHtml().split("{cke-peak}").join(C) }
                        r = n.blockLimit.getName();
                        if (/^\s+|\s+$/.test(C) && "span" in CKEDITOR.dtd[r]) { var A = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            C = A + C + A }
                        ...
                        if ((A = L.startPath().block) && (1 != A.getChildCount() || !A.getBogus())) a: { var y; if (1 == r.getChildCount() && a(y = r.getFirst()) && y.is(q) && !y.hasAttribute("contenteditable")) { A = y.getElementsByTag("*");
                                L = 0; for (I = A.count(); L < I; L++)
                    ...
                    if (L) {
                        ...
                        for (F(E, y); I < E.length; I++) {
                            ...
                            if (u) C = 0 < I;
                                ...
                                if ((u = y.startPath().block) && !u.equals(M)) { if (D = u.getBogus()) D.remove(), A.push(u);
                                    M = u }
                                J.firstNotAllowed && (G = 1);
                                if (G && J.isElement) {
                                    u =
                                        y.startContainer;
                                    for (R = null; u && !B[u.getName()][J.name];) { if (u.equals(r)) { u = null; break }
                                        R = u;
                                        u = u.getParent() }
                                    if (u) R && (W = y.splitElement(R), n.zombies.push(W), n.zombies.push(R));
                                        ...
                                        X = !I;
                                        u = I == E.length - 1;
                                        R = d(J.node, R); for (var T = [], aa = R.length, ba = 0, da = void 0, ea = 0, ga = -1; ba < aa; ba++) da = R[ba], " " == da ? (ea || X && !ba || (T.push(new CKEDITOR.dom.text(" ")), ga = T.length), ea = 1) : (T.push(da), ea = 0);
                                        u && ga == T.length && T.pop();
                                        X = T }
                                }
                                if (X) { for (; u = X.pop();) y.insertNode(u);
                    ...
                    D.moveToBookmark(X);
                    if (!n.dontMoveCaret) { for (M = e(D); M && a(M) && !M.is(B.$empty);) { if (M.isBlockBoundary()) D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                            else { if (f(M) && M.getHtml().match(/(\s|&nbsp;)$/g)) { S = null; break }
                                S = D.clone();
                ...
                table: function() {
                    function a(c) {
                        ...
                        h.guard = function(a, h) {
                            ...
                            else { if (k = !h) k = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!m || b(a, m));
    ...
    (function() {
        ...
        function g(a) { k(a, !1); var b = a.getDocument().createText(u);
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getType: n ? function() { var a = this._.cache; if (a.type) return a.type; var b = CKEDITOR.SELECTION_NONE; try { var c = this.getNative(),
            ...
            getRanges: function() {
                var a = n ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < g;) try { h = f[0 < m ? "previousSibling" : "nextSibling"], h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length, n = h), f = h } catch (K) { return { container: d, offset: a(f) } }
            ...
            getSelectedElement: function() {
                ...
                var b = this,
                    c = CKEDITOR.tools.tryThese(function() { return b.getNative().createRange().item(0) }, function() { for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && H[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT); return d && d.$ });
                        ...
                        if (l) this.fake(l);
                            ...
                            if (n) {
                                ...
                                for (t = 0; t < a.length; t++) {
                                    ...
                                    try { u.setEnd(l.endContainer.$, l.endOffset) } catch (C) { if (0 <= C.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) l.collapse(1), u.setEnd(l.endContainer.$, l.endOffset);
                                        else throw C; }
                                    f.addRange(u)
                                }
                            }
    ...
    (function() {
        ...
        function b(c) {
            ...
            if (c.collapsed) f = H(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
                ...
                var p = c.createBookmark(),
                    ...
                    r = q,
                    t;
                if (!l) { var u = c.getCommonAncestor(),
                        l = a(q, u),
                        u = a(v, u);
                ...
                for (r.getPosition(v) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(v)) r = null, l = !0;
                        ...
                        if (y && r.data("cke-bookmark")) { r = r.getNextSourceNode(!0); continue }
                        if (u && n && CKEDITOR.dtd.$block[y])
                            for (var A = r, x = e(A), z = void 0, B = x.length, E = 0, A = B && new CKEDITOR.dom.range(A.getDocument()); E < B; ++E) { var z = x[E],
                                    F = CKEDITOR.filter.instances[z.data("cke-filter")]; if (F ? F.check(this) : 1) A.selectNodeContents(z), b.call(this, A) }
                        ...
                        if (x)
                            if (z = r.getParent(), x = h, B = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[B] && !E || x.parentRule && !x.parentRule(z)) l = !0;
                                ...
                                if (t ||
                                    y && CKEDITOR.dtd.$removeEmpty[y] && (r.getPosition(v) | O) != O || (t = c.clone(), t.setStartBefore(r)), y = r.type, y == CKEDITOR.NODE_TEXT || u || y == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var y = r, P;
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                if (f) {
                    ...
                    p = this;
                b(); for (e = d; !e.equals(m);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? r.call(this, e) : n(e, h(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f }
            a.moveToBookmark(c);
        ...
        function l(a) { var b = a.createBookmark(!0),
            ...
            this._.enterMode && (c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR); for (var d, e = a.document, f; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = H(this, e, d), v(d, f));
            a.moveToBookmark(b) }
        ...
        function D(a) { for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || r.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return x.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
            ...
            removeFromRange: function(a) { this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? q : this.type == CKEDITOR.STYLE_OBJECT ? k : null; return this.removeFromRange(a) },
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? m(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                }
                return !1
            },
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (q.equals(e)) break;
                    if (!k && (v = q.getName(),
                            "true" == q.getAttribute("contenteditable") ? k = q : !g && d[v] && (g = q), a[v])) { if (v = !g && "div" == v) { a: { v = q.getChildren(); for (var f = 0, y = v.count(); f < y; f++) { var A = v.getItem(f); if (A.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[A.getName()]) { v = !0; break a } }
                                v = !1 }
                            v = !v }
                        v ? g = q : k = q }
                }
