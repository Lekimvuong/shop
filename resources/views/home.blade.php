        ...
        <div class="main-content fl-right">
            <div class="section" id="slider-wp">
                <div class="section-detail">
                    <div class="item">
                        <img src="template/public/images/slider-01.png" alt="">
                    </div>
                    <div class="item">
                        <img src="template/public/images/slider-02.png" alt="">
                    </div>
                    <div class="item">
                        <img src="template/public/images/slider-03.png" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="template/public/images/img-pro-07.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="template/public/images/img-pro-06.png">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="template/public/images/img-pro-09.png">
                            </a>
                    ...
                    <ul class="list-item">
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-13.png" alt="">
                            </a>
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-11.png" alt="">
                            </a>
                            <div class="info fl-right">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-12.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-05.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-22.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-23.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-18.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="template/public/images/img-pro-15.png" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
